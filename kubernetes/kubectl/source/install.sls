...
k8s-kubectl-release-source-install-file-directory:
  file.directory:
    ...
    - makedirs: True
    - require_in:
      - source: k8s-kubectl-release-source-install-source-extracted
    - recurse:
        - user
        - group
        - mode

k8s-kubectl-release-source-install-source-extracted:
  archive.extracted:
...
k8s-kubectl-release-source-install-cmd-run-make-install:
  cmd.run:
    ...
    - require:
      - archive: k8s-kubectl-release-source-install-source-extracted
